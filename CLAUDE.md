...
- v6.07~v6.09: ML 피처 확장 — dead_money(DCA고갈+TP1미도달), PnL 분산도(3종), TP1 도달 거리 평균
- v6.10: quality_score 분해(4종 qs_*), exit_reason ML 피처, VOLATILE regime_bonus 추가
- v6.11~v6.12: TP1→exit gap 피처(3종), net_pnl_pct 순수익률, sync_portfolio tp1 메타데이터 보존
